...
const translations = {
  tr: {
    ...
    "projects.theia.body": "Windows üzerinde sanal bir VR oluşturup bunu bir Android cihaza Wi-fi üzerinden paylaşmak için geliştirdim.",
    "projects.theia.footer": "C++, Winsock, Android Studio, VR, Sürücü",
    "projects.malzahar.title": "Malzahar",
    "projects.malzahar.body": "Nexus ile AES ve RSA protokollerini kullanarak haberleşen istemci uygulaması.",
    "projects.malzahar.footer": "AES, C++, RSA, TCP",
    ...
    "projects.codrive.title": "CoDrive",
    "projects.codrive.body": "E-Sys uygulamasının geliştirilmesi için tasarlanmış uygulama.",
    "projects.codrive.footer": "İş Analistliği, Proje Yönetimi, AI",
    ...
    "projects.nexus.body": "Şu an size kendimi anlatmamı sağlayan web sitesi.",
    "projects.nexus.footer": "HTML, CSS, JS",
  ...
  en: {
    ...
    "projects.janus.footer": "C++, Winsock",
    "projects.theia.title": "Theia",
    "projects.theia.body": "I built this to create a virtual VR machine on Windows and stream it to an Android device over Wi-Fi.",
    "projects.theia.footer": "C++, Winsock, Android Studio, VR, Driver",
    "projects.malzahar.title": "Malzahar",
    "projects.malzahar.body": "Client app that communicates with Nexus using RSA and AES.",
    "projects.malzahar.footer": "AES, C++, RSA, TCP",
    "projects.trieme.title": "Trieme",
    ...
    "projects.interbank.footer": "Java, Hibernate, MySQL, Kafka, SOAP API, HTML, CSS",
    "projects.codrive.title": "CoDrive",
    "projects.codrive.body": "E-Sys Development App",
    "projects.codrive.footer": "Business Analysis, Project Management, AI",
    "projects.aelita.title": "Aelita",
    ...
    "projects.nexus.title": "Nexus",
    "projects.nexus.body": "The website you are reading to learn about me.",
    "projects.nexus.footer": "HTML, CSS, JS",
    "projects.moba.title": "MOBA Manager",
